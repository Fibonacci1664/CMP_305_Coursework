...
{
	initShader(L"leaf_vs.cso", L"leaf_ps.cso");
}
...
void LeafShader::initShader(const wchar_t* vsFilename, const wchar_t* psFilename)
{
...
void LeafShader::setShaderParameters(ID3D11DeviceContext* deviceContext,
